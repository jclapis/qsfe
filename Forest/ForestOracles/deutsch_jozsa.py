...
class DeutschJozsa(unittest.TestCase):
    ...
    def check_if_constant_or_balanced(self, program, ancilla_cache, oracle, qubits, oracle_args):
        """
        ...
        measurement = program.declare("ro", "BIT", len(qubits))
    ...
    def run_test(self, oracle_name, oracle, should_be_constant, number_of_qubits, oracle_args):
        ...
        self.check_if_constant_or_balanced(program, {}, oracle, register, oracle_args)
