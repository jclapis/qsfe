...
namespace QSharpOracles
{
    ...
    public class TestSuiteRunner
    {
        ...
        /// <summary>
        /// This driver runs all of the tests for the Deutsch-Josza algorithm.
        /// </summary>
        [OperationDriver(TestNamespace = "QSharpOracles.DeutschJozsa",
            TestCasePrefix = "DJ_",
            Suffix = "_Test")]
        public void TestTarget(TestOperation Operation)
        {
            RunTest(Operation);
        }
